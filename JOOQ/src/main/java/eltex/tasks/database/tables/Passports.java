...
public class Passports extends TableImpl<PassportsRecord> {
    ...
    private static final long serialVersionUID = 1631067318;
    ...
    /**
     * The column <code>passports.number</code>.
     */
    public final TableField<PassportsRecord, String> NUMBER = createField("number", org.jooq.impl.SQLDataType.VARCHAR(255), this, "");

    /**
     * The column <code>passports.series</code>.
     */
    public final TableField<PassportsRecord, String> SERIES = createField("series", org.jooq.impl.SQLDataType.VARCHAR(255), this, "");
    ...
    public UniqueKey<PassportsRecord> getPrimaryKey() {
        return Internal.createUniqueKey(eltex.tasks.database.tables.Passports.PASSPORTS, "KEY_passports_PRIMARY", eltex.tasks.database.tables.Passports.PASSPORTS.ID);
    }
    ...
    public List<UniqueKey<PassportsRecord>> getKeys() {
        return Arrays.<UniqueKey<PassportsRecord>>asList(
              Internal.createUniqueKey(eltex.tasks.database.tables.Passports.PASSPORTS, "KEY_passports_PRIMARY", eltex.tasks.database.tables.Passports.PASSPORTS.ID)
        );
    }
