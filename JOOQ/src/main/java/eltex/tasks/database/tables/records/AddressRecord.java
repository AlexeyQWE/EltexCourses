...
public class AddressRecord extends UpdatableRecordImpl<AddressRecord> implements Record4<Long, String, String, String> {

    private static final long serialVersionUID = 692552086;
    ...
    /**
     * Setter for <code>address.building</code>.
     */
    ...
    /**
     * Getter for <code>address.building</code>.
     */
     ...
     */
    @Override
    public AddressRecord values(Long value1, String value2, String value3, String value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AddressRecord(Long id, String building, String city, String street) {
        super(Address.ADDRESS);
